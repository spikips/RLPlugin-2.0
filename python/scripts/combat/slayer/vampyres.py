# vampyre.py
# A script similar to the previous cannon spot but adapted for Vampyres
# Cannon tile: (3592, 3480, 0)
# Stand tile: (3590, 3481, 0)
# Keeps fixed camera, poison handling with Antidote++, same loot list (minus mossy key), added Blood shard
...
# Constants
CANNON_TILE = (3592, 3480, 0)  # Cannon position (x, y, plane)
STAND_TILE = (3590, 3481, 0)   # Standing position (x, y, plane)
...
def main():
    ...
    # Fixed camera setup (kept from previous script - adjust if needed for this spot)
    ...
    print("Starting Vampyre task with cannon.")
