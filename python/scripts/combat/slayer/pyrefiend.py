# pyrefiend.py
# A script for automating a slayer task using a cannon in Old School RuneScape via RuneLite plugin.
...
# Constants
CANNON_TILE = (2259, 2960, 0)  # Cannon position (x, y, plane)
STAND_TILE = (2257, 2959, 0)   # Standing position (x, y, plane)
...
def main():
    ...
    print("Starting slayer cannon task.")
