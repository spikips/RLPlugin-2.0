# lesser_demons.py
# Refactored using shared slayer utils (same clean style as bloodveld/ice_warriors)
# Same behavior: cannon (1440,10086,2), stand (1439,10084,2), random camera,
# protect melee, dynamic thresholds, full loot list (incl rune med helm), pick-up on task end
...
LOOT_ITEMS = [
    ...
    "torstol seed", "ranarr seed", "snape grass seed", "rune med helm",
    "Grimy ranarr weed"
]
LOOT_RADIUS = 15
...
def main():
    ...
    print("Setting up camera (adjust pitch/yaw/zoom if needed for this spot)...")
    ...
    print("Lesser Demons cannon task started.")
