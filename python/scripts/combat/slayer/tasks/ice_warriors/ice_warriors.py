# ice_warriors.py
# Refactored using shared slayer utils (same clean style as crocodile.py)
# Same behavior: cannon (3051,9587,0), stand (3052,9585,0), protect melee,
# dynamic thresholds, same loot list, pick-up on task end
...
def main():
    ...
    print("Setting up camera (adjust pitch/yaw/zoom if needed for Asgarnian Ice Dungeon)...")
    ...
    print("Ice Warriors cannon task started.")
