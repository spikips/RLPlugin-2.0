# hill_giants.py
# Refactored using shared slayer utils (same clean style as bloodveld/crocodile)
# Same behavior: cannon (1434,9886,0), stand (1435,9884,0), random camera,
# protect melee, dynamic thresholds, full loot list (incl giant key + totems), pick-up on task end
...
def main():
    ...
    print("Hill Giants cannon task started.")
