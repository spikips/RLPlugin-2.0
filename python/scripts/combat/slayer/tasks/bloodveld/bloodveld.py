# bloodveld.py
# Refactored using shared slayer utils (same clean style as crocodile/ice_warriors)
# Same behavior: cannon (2483,9818,0), stand (2484,9820,0), random camera,
# protect melee, dynamic thresholds, full loot list, pick-up on task end
...
# Constants
CANNON_TILE = (2483, 9818, 0)
STAND_TILE  = (2484, 9820, 0)
LOOT_ITEMS = [
    "loop half of key", "tooth half of key", "rune spear", "shield left half",
    "dragon spear", "torstol seed", "snapdragon seed", "cadantine seed",
    "ranarr seed", "snape grass seed", "grimy ranarr weed", "blood rune",
    "rune med helm"
]
LOOT_RADIUS = 15
...
def main():
    ...
    print("Bloodveld cannon task started.")
