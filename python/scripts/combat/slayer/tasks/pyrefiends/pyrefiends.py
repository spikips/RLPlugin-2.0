# pyrefiend.py
# Refactored using shared slayer utils (pattern matches kalphites/vampyre/ghoul/ice_warriors/hobgoblins/ice_giants)
# Same behavior: cannon (2259,2960,0), stand (2257,2959,0), random camera 450–512 / 250–500 / 505,
...
# Constants
CANNON_TILE = (2259, 2960, 0)
STAND_TILE  = (2257, 2959, 0)
LOOT_ITEMS = [
    "loop half of key", "tooth half of key", "rune spear",
    "shield left half", "dragon spear", "Grimy ranarr weed"
]
LOOT_RADIUS = 15
...
def main():
    ...
    print("Pyrefiend cannon task started.")
