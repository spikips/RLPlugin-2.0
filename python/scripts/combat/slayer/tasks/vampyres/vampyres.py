# vampyre.py
# Refactored like kalphites.py, sand_crabs.py, ghoul.py
# Uses shared slayer utils → ~70 lines removed, same exact behavior
# Cannon (3592, 3480, 0), stand (3590, 3481, 0), fixed camera, lowest-dose Antidote++, loot list with Blood shard
...
# Constants
CANNON_TILE = (3592, 3480, 0)
STAND_TILE  = (3590, 3481, 0)
LOOT_ITEMS = [
    "loop half of key", "tooth half of key", "rune spear", "shield left half",
    "dragon spear", "long bone", "curved bone", "snapdragon seed",
    "torstol seed", "ranarr seed", "snape grass seed", "Blood shard",
    "Grimy ranarr weed"
]
LOOT_RADIUS = 15

def drink_antidote():
    """Lowest dose first (1→4) - same priority as kalphites.py"""
    inv_data = inventory()
...
def main():
    ...
    print("Vampyre cannon task started.")
    ...
    while True:
        ...
        # Return to stand tile after placement attempts
